...
import { Avatar, Box, Button, Card, CardContent, Grid, Typography, ThemeProvider } from '@mui/material';
            ...
            <Card sx={{ minWidth: 300 }}>
                <CardContent>
                    <Grid container spacing={2} alignItems="center">
                        ...
                        <Grid sm>
                            <Typography variant="h6" color="primary" align="left" sx={{ mt: 2, ml: 2 }}>
                    ...
                    <Box mt={2}>
                        ...
                        <Grid container mt={1} spacing={1} justifyContent="center">
                            {games.map((game, index) => (
                                <Grid item key={index}>
                                    <img className="game-image mb-2" src={game.cover} alt={game.name} style={{ width: 80, height: 80 }} />
                                </Grid>
                            ))}
                        </Grid>
                    </Box>
                    ...
                    <Box mt={2} textAlign="center">
                        <Button variant="contained" color="primary" startIcon={<Chat />} sx={{ color: theme.palette.text.primary }}>
                            Start Chatting
                        </Button>
                    </Box>
                </CardContent>
